...
-->
    <p>
		Please contact us using the following online form.
    </p>
...
if (!$resp->is_valid) {
    ...
    <?}?>
		...
		<tr><td>
		<form method="post" action="ictus.php" name="frmct" id="form1">
    ...
    <?php 
		 ...
		 // $headers .= 'Bcc: hello@hello.com' . "\r\n";
		  ...
		  mail( "icbn.comm@gmail.com", "[ICBN:ContactUs]: $subject",
		  $message, $headers );
...
<p class="subtitle">ICBN Board Organization</p>
You may reach ICBN Board at icbn.contact@usicbn.org or use the form above for any matter and inshallah we will be glad to help you out.
